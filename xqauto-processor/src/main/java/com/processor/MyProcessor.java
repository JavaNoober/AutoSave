...
public class MyProcessor extends AbstractProcessor{
	...
	public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
		for (Element annotatedElement: roundEnvironment.getElementsAnnotatedWith(NeedSave.class)) {
			...
			HelperClass helperClass = getHelperClass(annotatedElement);

//			getHelperClass(annotatedElement);
//			TypeElement encloseElement = (TypeElement) annotatedElement.getEnclosingElement();
//			encloseElement.getSimpleName().toString();//Ԫ������class������
//			MethodSpec main = MethodSpec.methodBuilder("main")
//					.addModifiers(Modifier.PUBLIC, Modifier.STATIC)
//					.returns(void.class)
//					.addParameter(String[].class, "args")
//					.addStatement("$T.out.println($S)", System.class, encloseElement.getSimpleName().toString())
//					.build();
//
//			TypeSpec cacheClass = TypeSpec.classBuilder(annotatedElement.getSimpleName().toString())
//					.addModifiers(Modifier.PUBLIC, Modifier.FINAL)
//					.addMethod(main)
//					.build();
//
//			JavaFile javaFile = JavaFile.builder("com.xiaoqi.annotationdemo.savehelper", cacheClass).build();
//			try {
